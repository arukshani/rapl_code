# This code snippet is taken from https://github.com/Breakend/experiment-impact-tracker/blob/master/experiment_impact_tracker/cpu/rapl.py
# Modified slightly according to this project's requirement
...
def main(args):
    ...
    df_energy = pd.DataFrame(columns=['timestamp', 'total_intel_energy', 'total_dram_energy', 'total_cpu_energy', 'total_gpu_energy'])
    data = {}
    while(True):
        ...
        df_energy.to_csv(args.log, mode="w", header=False, index=False)
